              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  onSubmitted: (productName) {
                    // log(productName);
                    context.read<UsersProductProvider>().getSearchedProducts(
        ...
        builder: (context, usersProductProvider, child) {
          if (usersProductProvider.productsFetched == false) {
            ...
            if (usersProductProvider.products.isEmpty) {
              return const Center(child: Text('Opps! Product not found'));
            } else {
              return ListView.builder(
                itemCount: 4,
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  ProductModel currentProduct = 0 as ProductModel;
                  return InkWell(
                    onTap: () async {
