...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  TextEditingController discountedProductPriceController = TextEditingController();
    ...
    if (context.read<ProductProvider>().productImages.isNotEmpty) {
      ...
      ProductModel model = ProductModel(
        ...
        discountedPrice: double.parse(
          discountedProductPriceController.text.trim(),
        ),
        productID: productID,
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: addProductBtnPressed
                    ...
                    : Text('Add Product', style: textTheme.bodyMedium),
              ),
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.add, size: height * 0.09, color: greyShade3),
                      Text(
                        'Add Product',
                        style: textTheme.displayMedium!.copyWith(
                          color: greyShade3,
